...
def main():
  ...
  dataset_name = 'ufop' #params.dataset_name
  ...
  #   os.mkdir(data_path)
  # data = pd.read_csv(os.path.join(data_path, data_name), low_memory=True)

  # transform = transforms.Compose([
  #   transforms.Resize((100,100)), #base_model.image_size
  #   transforms.ToTensor(),
  # ])

  # dt = Data(data=data, dataset_name=dataset_name, transform=transform)

  # X, y = dt.get_features()

  # print(X, y)

  # train_dataset = TrainDataset(X=X, y=y, transform=transformation)
