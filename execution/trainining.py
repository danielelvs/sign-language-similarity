...
class Training:
	...
	def exec(model, train_dataloader, val_dataloader, num_epochs, criterion, optimizer, device, evaluator, k_shot):
		"""
		Initialize the training setup with given parameters.
		"""
		model.train()
		best_loss = float("inf")
		best_loss_history = []
		...
		for epoch in range(num_epochs):
			...
			accuracy = evaluator.exec(model, val_dataloader, k=k_shot)
